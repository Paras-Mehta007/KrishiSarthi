      ...
      <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
        ...
        >
          ...
          <div className="flex items-center space-x-3 mt-4 lg:mt-0">
            <NavLink
              to="/chatbot"
              className= "text-gray-800 border border-black-500 hover:bg-gray-100 font-medium rounded-lg text-sm px-4 py-2"
            >
              Chatbot
            </NavLink>
            <NavLink
              to="/login"
              className="text-white bg-green-600 hover:bg-green-700 font-medium rounded-lg text-sm px-4 py-2     border-black-500"
